function util() {
    ...
    var publicMethods = {
        ...
        createAlert: function (id, _measure) {
            ...
            output += '<div id="Modal_' + id + '" class="modal fade" role="dialog">' +
        ...
        getDisplayColor: function (index, _measureProp) {
            if (_measureProp[index]["displayColor"] == "" || _measureProp[index]["displayColor"] == null || _measureProp[index]["displayColor"] == undefined) {
                return COMMON.COLORSCALE(index);
            }
            return _measureProp[index]["displayColor"]
        },

        getBorderColor: function (index, _measureProp) {
            if (_measureProp[index]["borderColor"] == "" || _measureProp[index]["borderColor"] == null || _measureProp[index]["borderColor"] == undefined) {
                return COMMON.COLORSCALE(index);
            }
            return _measureProp[index]["displayColor"];
        },
